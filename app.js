...
const germanCar = [23, 25, 222, 13,3, 3];
// const updatedGermanCar = germanCar.map(numberPlate => numberPlate * numberPlate);
// console.log(updatedGermanCar);
const [m1, m2, ...oldModel] = germanCar;
